...
public class MemoryManager {
    ...
    private void pageFault(int pageNumber) {
        if (myPageReplacementAlgorithm == Main.NO_PAGE_REPLACEMENT) {
            handlePageFault(pageNumber);
        }

        if (myPageReplacementAlgorithm == Main.FIFO_PAGE_REPLACEMENT) {
            handlePageFaultFIFO(pageNumber);
        }

        if (myPageReplacementAlgorithm == Main.LRU_PAGE_REPLACEMENT) {
