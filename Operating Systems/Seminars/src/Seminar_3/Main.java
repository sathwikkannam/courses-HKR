...
public class Main {
    ...
    private static final String BACKING_STORE_FILE = "Seminar_3/resources/BACKING_STORE.bin";
    ...
    private static void testTaskOne() {
        ...
        MemoryProcess mp = new MemoryProcess("Seminar_3/resources/addresses.txt", memoryManager);
        mp.callMemory();
